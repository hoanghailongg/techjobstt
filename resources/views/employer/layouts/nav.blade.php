...
<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
            <a href="{{config('app.url_employer')}}" class="nav-link">Home</a>
        </li>
    </ul>
...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="{{route('employer.dashboard')}}" class="brand-link">
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            ...
            <div class="info">
                <a href="javascript:void(0)" class="d-block">{{Auth::guard('employer')->user()->full_name ?? 'Admin'}}</a>
            </div>
        </div>
            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                <li class="nav-item">
                    <a href="{{route('employer.dashboard')}}"
                       class="nav-link {{ (request()->is('employer')) ? 'active' : '' }}">
                ...
                <li class="nav-item">
                    <a href="{{route('employer.jobs.index')}}"
                       class="nav-link {{ (request()->is('employer/jobs*')) ? 'active' : '' }}">
                ...
                <li class="nav-item">
                    <a href="{{route('employer.follow.index')}}"
                       class="nav-link {{ (request()->is('employer/follow*')) ? 'active' : '' }}">
                ...
                <li class="nav-item">
                    <a href="{{route('employer.profile.index')}}"
                       class="nav-link {{ (request()->is('employer/profile*')) ? 'active' : '' }}">
