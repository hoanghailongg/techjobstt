            ...
            <div class="w-login m-auto">
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12 col-12 login-main-right">
                        ...
                        <form class="login-form reg-form" action="{{ route('employer.register.store') }}" method="post">
                            @csrf
                            ...
                            <div class="input-div one">
                                <div class="div lg-lable">
                                    ...
                                    <input type="text" class="input form-control-lgin" name="name" value="{{ old('name') }}">
                                </div>
                            </div>
                            <div class="input-div one">
                                <div class="div lg-lable">
                                    <h5>Địa chỉ công ty<span class="req">*</span></h5>
                                    <input type="text" class="input form-control-lgin" name="address" value="{{old('address')}}">
                                </div>
                            </div>
                            <div class="form-group d-block frm-text">
                                <a href="#" class="fg-login d-inline-block"></a>
                                <a href="{{ route('employer.login') }}" class="fg-login float-right d-inline-block">Bạn đã có tài khoản?
                                    Đăng Nhập</a>
                            </div>

                            <input name="submit" type="submit"
                                   class="btn btn-primary float-right btn-login d-block w-100"
                                   value="Đăng ký nhà tuyển dụng">
                            ...
                            <div class="form-group d-block w-100 mt-5">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-12 pr-7">
                                        <a href="{{ route('register') }}" class="text-capitalize font-weight-bold btn btn-warning btnw w-100 float-left">
                                            <span>Đăng ký với tư cách nhà người tìm việc</span>
                                        </a>
                                    </div>
                                </div>
                            </div>
