                ...
                <div class="row">
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-warning">
                            <div class="inner">
                                <h3>{{number_format($countFollowOfCompany)}}</h3>
                                <p>Đơn xin việc</p>
                            </div>
                            <div class="icon">
                                <i class="ion ion-person-add"></i>
                            </div>
                            <a href="{{route('employer.follow.index')}}" class="small-box-footer">Xem thêm <i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                    <!-- ./col -->
                    <div class="col-lg-3 col-6">
                    ...
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-danger">
                            ...
                            <a href="{{ route('employer.jobs.index') }}" class="small-box-footer">Xem thêm <i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                    <!-- ./col -->
                </div>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="tableListJob" class="table dt-responsive">
                                        ...
                                        <tbody>
                                        @php $i = 0; @endphp
                                        @foreach($getListJobsOfCompany as $lJob)
                                            <tr>
                                                <td>{{ ++$i }}</td>
                    ...
                    <div class="col-lg-12 connectedSortable">
                        <div class="card">
                            ...
                            <div class="card-body p-0">
                                <div class="table-responsive">
                                    <table class="table m-0">
                                        ...
                                        <tbody>
                                        @php $i = 0; @endphp
                                        @foreach($getListFollowOfCompany as $follow)
                                            <tr>
                                                <td>{{ ++$i }}</td>
                            ...
                            <div class="card-footer text-center">
                                <a href="{{route('employer.follow.index')}}" class="uppercase">Xem tất cả đơn xin việc</a>
                            </div>
                            <!-- /.card-footer -->
                        </div>
                    </div>
