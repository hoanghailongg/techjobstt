            ...
            <div class="w-login m-auto">
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12 col-12 login-main-right">
                        ...
                        <form action="{{ route('login') }}" method="post" id="form_login" onsubmit="return false">
                            @csrf
                            <input type="hidden" id="url_previous" value="{{route('home')}}">
                            ...
                            <div class="form-group d-block frm-text">
                                ...
                                <a href="{{ route('register') }}" class="fg-login float-right d-inline-block">Bạn chưa
                            ...
                            <div class="form-group d-block w-100 mt-5">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-12 pr-7">
                                        <a href="{{ route('employer.login') }}" class="text-capitalize font-weight-bold btn btn-warning btnw w-100 float-left">
                                            <span>Đăng nhập với tư cách nhà tuyển dụng</span>
                                        </a>
                                    </div>
                                </div>
                            </div>
